...
// GetAllUsers @Summary Lấy tất cả người dùng
// @Description Trả về danh sách tất cả người dùng trong hệ thống.
// @Tags Users
// @Produce json
// @Success 200 {object} map[string]interface{} "Lấy danh sách người dùng thành công"
// @Failure 40001 {object} map[string]interface{} "Lỗi khi lấy danh sách người dùng"
...
// GetUserById @Summary Lấy người dùng theo ID
// @Description Lấy thông tin chi tiết của người dùng theo ID.
// @Tags Users
// @Produce json
// @Param id path int true "ID người dùng"
// @Success 200 {object} map[string]interface{} "Lấy người dùng theo ID thành công"
// @Failure 40001 {object} map[string]interface{} "ID không hợp lệ"
// @Failure 40002 {object} map[string]interface{} "Lỗi khi lấy người dùng theo ID"
...
// DeleteUser @Summary Xóa người dùng
// @Description Xóa một người dùng khỏi hệ thống theo ID.
// @Tags Users
// @Produce json
// @Param id path int true "ID người dùng cần xóa"
// @Success 200 {object} map[string]interface{} "Xóa người dùng thành công"
// @Failure 40001 {object} map[string]interface{} "ID không hợp lệ"
// @Failure 40005 {object} map[string]interface{} "Lỗi khi xóa người dùng"
