...
type UserService interface {
	LoginUser(ctx *gin.Context, email string, password string) (*po.User, string, string, error)
...
func (service *userService) LoginUser(ctx *gin.Context, email string, password string) (*po.User, string, string, error) {
...
func (service *userService) FindUserWithRolesAndPermissionsByID(id int) (*po.User, error) {
	return service.userRepository.FindUserWithRolesAndPermissionsByID(id)
}
